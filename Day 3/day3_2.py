...
def validar_engranaje(matriz, nums, x, y):
    ...
    return resultados[0] * resultados[1] if len(resultados) == 2 else 0
...
def main():
    ...
    for x, y in syms.keys():
        list_numbers_adj = validar_engranaje(nested_lines, nums, x, y)
        total_answer.append(list_numbers_adj)
